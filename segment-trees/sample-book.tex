...
\par\smallcaps{Published by Adi Eyal}

\par\smallcaps{adi.eyal.github.io/segment-trees}
...
\subimport{./}{ch1 - Introduction.tex}
\chapter{Representation \& Build}
\subimport{./}{ch2 - Representation.tex}
\chapter{Queries \& Point Updates}
\subimport{./}{ch3 - Queries.tex}

% Part II
\part{Node Design \& Range Updates}
\chapter{Segment Tree Node Design}
\subimport{./}{ch4 - Node Design.tex}
\chapter{Lazy Propagation (Range Updates)}
\subimport{./}{ch5 - Lazy Propagation.tex}

\part{Advanced Variants}
\chapter{Persistent / Versioned Trees}
\subimport{./}{ch6 - Persistent Segment Trees.tex}
\chapter{Specialised Variants}
\subimport{./}{ch7 - Specialised Variants.tex}
\chapter{Segment Tree Beats}
\subimport{./}{ch8 - Segment Tree Beats.tex}

\part{Appendices}
\chapter{Code Listings}
\subimport{./}{app - Code Listings.tex}
\chapter{Problems}
\subimport{./}{app - Problems.tex}

% % \chapter{Big-O Quick-Reference}
% % \chapter{Glossary of Common Contest Problems Referenced}
